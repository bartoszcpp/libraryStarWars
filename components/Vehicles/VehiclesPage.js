          ...
          <div className="object">
            ...
            <div className="row">
              <div className="col-md-4">
                <h2>Data: </h2>
                <p>
                  Cargo capacity: <b>{vehiclesObject.cargo_capacity}</b>
                </p>
                <p>
                  Consumables: <b>{vehiclesObject.consumables}</b>
                </p>
                <p>
                  Cost in credits: <b>{vehiclesObject.cost_in_credits}</b>
                </p>
                <p>
                  Crew: <b>{vehiclesObject.crew}</b>
                </p>
                <p>
                  Length: <b>{vehiclesObject.length}</b>
                </p>
                <p>
                  Manufacturer: <b>{vehiclesObject.manufacturer}</b>
                </p>
                <p>
                  Max atmosphering speed:{" "}
                  <b>{vehiclesObject.max_atmosphering_speed}</b>
                </p>
                <p>
                  Model: <b>{vehiclesObject.model}</b>
                </p>
                <p>
                  Passengers: <b>{vehiclesObject.passengers}</b>
                </p>
                <p>
                  Vehicle class: <b>{vehiclesObject.vehicle_class}</b>
                </p>
              </div>
              <div className="col-md-4">
                <h2>Films: </h2>
