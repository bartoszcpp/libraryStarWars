...
const SpeciesPage = (props) => {
    const { name } = props;
    const { species, people, films, planets, basedUrl } = React.useContext(AppContex);
    const data = species
    ...
    if (speciesObject != undefined) {
        ...
        let homeworld = planets.find(dataPlanet => dataPlanet.url === speciesObject.homeworld);
                    ...
                    <div className="object">
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <h2>Data: </h2>
                                <p>Average height: <b>{speciesObject.average_height}</b></p>
                                <p>Average lifespan: <b>{speciesObject.average_lifespan}</b></p>
                                <p>Classification: <b>{speciesObject.classification}</b></p>
                                <p>Designation: <b>{speciesObject.designation}</b></p>
                                <p>Eye colors: <b>{speciesObject.eye_colors}</b></p>
                                <p>Hair colors: <b>{speciesObject.hair_colors}</b></p>
                                <p>
                                    Homeworld:
                                    <a href={`${basedUrl}planets/${slugNameHomeworld}`}> {homeworld.name}</a>
                                </p>
                                <p>Language: <b>{speciesObject.language}</b></p>
                                <p>Skin colors: <b>{speciesObject.skin_colors}</b></p>
                            </div>
                            <div className="col-md-4">
                                <h2>Films: </h2>
                                {listOfFilms}
