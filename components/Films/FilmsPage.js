...
const FilmsPage = (props) => {
    const { title } = props;
    const { films, people, planets, species, starships, vehicles, basedUrl } = React.useContext(AppContex);
    const data = films
                    ...
                    <div className="object">
                        ...
                        <div className="row">
                            <div className="col-md-4">
                                <h2>Data: </h2>
                                <p>Director: <b>{filmsObject.director}</b></p>
                                <p>Episode id: <b>{filmsObject.episode_id}</b></p>
                                <p>Opening crawl: <b>{filmsObject.opening_crawl}</b></p>
                                <p>Producer: <b>{filmsObject.producer}</b></p>
                                <p>Release date: <b>{filmsObject.release_date}</b></p>
                            </div>
                            <div className="col-md-4">
                                <h2>Characters: </h2>
                                {listOfPeople}
